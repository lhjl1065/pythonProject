...
def find_image(screenshot, target_image_path, threshold=0.5):
...
# 示例用法
target_image_path1 = r"C:\Users\Administrator.Win102022OLTGCK\Pictures\QIANGPAO.png"  # 请确保此处设置了正确的目标图像文件路径
target_image_path2 = r"C:\Users\Administrator.Win102022OLTGCK\Pictures\HALO.png"  # 请确保此处设置了正确的目标图像文件路径
